...
const NewsletterSM = () => {
  return (
    <div className="md:block sm:block lg:hidden px-11 bg-[#f6deb2] my-28 py-20">
      <div>
      ...
      <div className="flex flex-wrap flex-row mt-8 mx-8 justify-center">
        <form>
            ...
            <div className="">
                <select className="w-full border-1 rounded-xl text-black border-[#C5C5C5] py-6 mt-6" required>
            ...
            <hr className="w-full border-black mt-12" />
              <div >
                <button
                    type="submit"
